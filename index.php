...
<html lang="ro-RO">
	<head>
		...
		if($edit)
			__($title." &raquo; Edit / ");
		?><?php __($spkcore->getConfig('title'))?>
		</title>
		...
		<div class="toolstrip">
			<div class="topMenu">
				<ul>
					...
					<li><a href="htto://s.duricu.ro" title="<?php ___("close")?>" class="no-text close">&nbsp;</a></li>
				</ul>
				<div class="clear"></div>
				<ul>
...
<option value="<?php __($height)?>"><?php __($height)?></option>
			...
			<div id="about" title="<?php ___("about")?>">
				<table>
					...
					<tr>
						<td><?php __($spkcore->version())?></td>
					</tr>
					<tr>
						<td><a href="https://github.com/thg2oo6/Sketch-Bin">GitHub - https://github.com/thg2oo6/Sketch-Bin</a></td>
					</tr>
					<tr>
