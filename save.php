...
if($clean['type']=='new'){
	...
	mysql_query("INSERT INTO `draws` (`id`,`title`,`filename`,`creationdate`,`modificationdate`,`type`,`width`,`height`,`bkgcolor`) VALUES (NULL,'{$clean['name']}','{$zName}','{$curdate}','{$curdate}','extended','{$clean['width']}','{$clean['height']}','{$clean['bkcolor']}');");
	echo "good|".$zName;
